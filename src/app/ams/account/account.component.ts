...
export class AccountComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.dataForm = this.fb.group({
            ...
            account_title: new FormControl(null, [Validators.required, Validators.maxLength(50)]),
        ...
        this.ds.bankLink().subscribe((resp) => {
    ...
    setPagination(page: number) {
        ...
        this.router.navigate(['/user/banks'], { queryParams: filtersParam, replaceUrl: true })
    }
    ...
    save(f: any) {
        ...
        const params = {
            ...
            bank_id: this.dataForm.value.bank_id,
            account_title: this.dataForm.value.account_title,
            account_no: this.dataForm.value.account_no,
            // iban: this.dataForm.value.iban,
            branch_code: this.dataForm.value.branch_code,
            branch_address: this.dataForm.value.branch_address,
