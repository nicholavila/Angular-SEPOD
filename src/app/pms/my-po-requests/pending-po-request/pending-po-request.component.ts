...
@Component({
    selector: 'app-pending-po-request',
    templateUrl: './pending-po-request.component.html',
    styleUrls: ['./pending-po-request.component.css']
})
export class PendingPoRequestComponent implements OnInit, OnDestroy {
    dataStatus = 'fetching'
    moment = moment
    ...
    showItem(i: any, id) {
        ...
        if (this.dataList[i].pendingItems) {
            return
        }
        this.dataList[i].dataStatusInner = 'fetching'
        this.ds.pendingPoRequestItems({ id }).subscribe((resp: any) => {
            if (resp.success === true) {
                this.dataList[i].pendingItems = resp.data
    ...
    setPagination(page: number) {
        ...
        this.router.navigate(['/user/my-pending-po-request'], { queryParams: filtersParam, replaceUrl: true })
    }
