...
@Component({
    selector: 'app-vp-product-bulk-upload-list',
    templateUrl: './vp-product-bulk-upload-list.component.html',
    styleUrls: ['./vp-product-bulk-upload-list.component.css']
})
export class VpProductBulkUploadListComponent implements OnInit, OnDestroy {
    dataStatus = 'fetching'
    dataList = []
    moment = moment
    dataForm: FormGroup
    ...
    breadCrum = [
        {
            link: '/user/vp-product-bulk-upload-list',
            value: 'Virtual  Product Bulk Uploads'
        }
    ]
    pagination: any = []
    page = 1
