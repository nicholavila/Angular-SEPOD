...
export class ClientOrdersComponent implements OnInit {
    ...
    constructor(
        ...
        this.ds.getOrderCount().subscribe((resp) => {
    ...
    setPagination(page: number) {
        ...
        this.router.navigate([this.api.checkUser() + '/my-orders'], { queryParams: filtersParam, replaceUrl: true })
    }
    ...
    checkStatus(val: any) {
        ...
        if (this.changeStatusValue == 'received' || this.changeStatusValue == 'in_factory' || this.changeStatusValue == 'in_packing') {
            ...
            this.router.navigate([this.api.checkUser() + '/create-shipment'], { queryParams: { orderId: this.selectedId }, replaceUrl: true })
    ...
    SaveResponse(data, f) {
        ...
        // const params = { invoice_date: moment(data.value.invoice_date).format('YYYY-MM-DD') }
