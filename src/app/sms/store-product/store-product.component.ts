...
export class StoreProductComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.breadCrum.push({
            link: this.api.checkUser() + '/store-products',
            params: { store_id: this.storeProId },
            value: 'Store Products List'
        })
    ...
    setPagination(page: number) {
        ...
        this.router.navigate([this.api.checkUser() + '/store-products'], {
