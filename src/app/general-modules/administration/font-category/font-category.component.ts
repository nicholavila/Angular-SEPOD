...
@Component({
    selector: 'app-font-category',
    templateUrl: './font-category.component.html',
    styleUrls: ['./font-category.component.css']
})
export class FontCategoryComponent implements OnInit, OnDestroy {
    dataStatus = 'fetching'
    dataList = []
    dataForm: FormGroup
    selectedIndex = -1
