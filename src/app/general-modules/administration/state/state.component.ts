...
export class StateComponent implements OnInit {
    ...
    constructor(
        ...
        this.dataForm = this.fb.group({
            ...
            country_id: new FormControl(null, [Validators.required, Validators.maxLength(50)])
        })
    ...
    setPagination(page: number) {
        ...
        this.router.navigate(['/user/state'], { queryParams: filtersParam, replaceUrl: true })
    }
    ...
    save(f: any) {
        ...
        const params = {
            ...
            country_id: this.dataForm.value.country_id
        }
