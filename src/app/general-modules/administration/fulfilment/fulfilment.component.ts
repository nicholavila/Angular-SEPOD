...
export class FulfilmentComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.dataForm = this.fb.group({
            ...
            client_friendly_name: new FormControl(null, [Validators.required, Validators.maxLength(50)]),
    ...
    getList() {
        ...
        list.subscribe((resp: any) => {
            if (resp.success === true) {
                ...
                this.router.navigate(['/user/fulfilment'], { queryParams: params, replaceUrl: true })
    ...
    setPagination(page: number) {
        ...
        this.router.navigate(['/user/fulfilment'], { queryParams: filtersParam, replaceUrl: true })
    }

    openModal(formModal, index) {
        this.modalTitle = 'Add New Fulfilment'
        if (index > -1) {
            this.selectedIndex = index
            this.dataForm.controls.id.setValue(this.dataList[index].id)
            this.dataForm.patchValue(this.dataList[index])
            this.modalTitle = 'Edit Fulfilment'
        }
    ...
    save(f: any) {
        ...
        const params = {
            ...
            client_friendly_name: this.dataForm.value.client_friendly_name,
