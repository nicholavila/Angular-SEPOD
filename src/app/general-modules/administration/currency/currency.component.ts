...
export class CurrencyComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.dataForm = this.fb.group({
            ...
            symbol: new FormControl(null, [Validators.required, Validators.maxLength(5)]),
    ...
    getList() {
        ...
        list.subscribe((resp: any) => {
            if (resp.success === true) {
                ...
                this.router.navigate(['/user/currency'], { queryParams: params, replaceUrl: true })
    ...
    setPagination(page: number) {
        ...
        this.router.navigate(['/user/currency'], { queryParams: filtersParam, replaceUrl: true })
    }
    ...
    save(f: any) {
        ...
        const params = {
            ...
            short_name: this.dataForm.value.short_name,
            symbol: this.dataForm.value.symbol,
